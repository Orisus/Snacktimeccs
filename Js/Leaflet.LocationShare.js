...
var sendIcon = L.icon({
  iconUrl: "file:///C:/Users/Mariano/Documents/SnackTime/SnackTime/Js/dist/images/bicycle-rider.png",
...
receiveIcon = L.icon({
  iconUrl: "file:///C:/Users/Mariano/Documents/SnackTime/SnackTime/Js/dist/images/LOGO.SNACK.png",
  iconSize:     [50, 50], // size of the icon
  iconAnchor:   [25, 50], // point of the icon which will correspond to marker's location
  popupAnchor:  [0, -30] // point from which the popup should open relative to the iconAnchor
})
...
LS.Send.UpdateMessage = function( text ){
  ...
  LS.Send.Message = encodedForUrl.split(/\n/);
}
